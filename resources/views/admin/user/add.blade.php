...
<div class="card card-primary">
    ...
    <form action="" method="post" id="addNewUser">
      ...
      <div class="card-body">
        ...
        <label for="exampleInputEmail1">Cấp Quyền</label>
        @foreach ($roles as $r)
        <div class="form-check">
            <input class="form-check-input role" value="{{$r->id}}" type="radio" id="{{$r->id}}">
            <input class="form-check-label role" name="role" value="{{$r->name}}" disabled>
        </div>
        @endforeach
      </div>
      <!-- /.card-body -->
