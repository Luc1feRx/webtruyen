...
@section('content')
        <div class="card-body">
            ...
            <tr>
                ...
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Tên Chapter</th>
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Truyện</th>
            ...
            <tbody>
                ...
                <tr class="odd">
                    ...
                    <td>
                        <a class="btn btn-primary btn-sm" href="{{ route('chapters.edit', ['chapter'=>$item->id]) }}"><i class="fas fa-edit"></i></a>
                        <form action="{{ route('chapters.destroy', ['chapter'=>$item->id]) }}" method="post">
                            @method('DELETE')
                            {{ csrf_field() }}
